    ...
    function init() {
        ...
        scene.background = new THREE.Color( 0xe7e7e8 );
        ...
        this.renderer.setClearColor( 0xe7e7e8 );
        ...
        loader.load( 'files/js/three/model/untitled.gltf', function ( gltf ) {
    ...
    function setContent(object, clips) {
        var obj1 = new THREE.Box3();
        var obj2 = new THREE.Vector3();
        var obj3 = new THREE.Vector3();
        object.updateMatrixWorld();
        const box = obj1.setFromObject(object);
        const size = box.getSize(obj2).length();
        const center = box.getCenter(obj3);
